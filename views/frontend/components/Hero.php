  <div class="sale-banner">
      <marquee behavior="scroll" direction="left" scrollamount="6">
          ...
          Giảm giá <strong>50%</strong> tất cả sản phẩm thời trang nam trong tuần này!
          <span class="fire">🔥</span>
          Mua ngay để không bỏ lỡ — Free ship toàn quốc 🚚
      </marquee>
  </div>
  <div class="swiper mySwiper">
      <div class="swiper-wrapper">
          ...
          <div class="swiper-slide flex flex-col sm:flex-row border border-gray-400">
              ...
              <img class="h-[671px] sm:w-1/2 object-cover object-top bg-top" src="<?= $assets['hero_img'] ?>"
                  alt="Hero">
          </div>
          ...
          <div class="swiper-slide flex flex-col sm:flex-row-reverse border border-gray-400">
              ...
              <div class="w-full sm:w-1/2 flex items-center justify-center py-10 sm:py-0 px-6 sm:px-12 bg-[#fdfdfd]">
                  <div class="text-[#2b2b2b]">
                      ...
                      <a href="#"
                          class="inline-block px-8 py-3 bg-black text-white text-sm uppercase tracking-wide hover:bg-gray-800 transition">
                          Khám phá ngay
                      </a>
                  </div>
              </div>
              ...
              <div class="w-full sm:w-1/2">
                  <img src="<?= $assets['hero_img_2'] ?? $assets['hero_img'] ?>" alt="Slide 2"
                      class="h-[671px] w-full object-cover object-center" />
              </div>
          </div>
          ...
          <div class="swiper-slide relative h-[671px]">
              <!-- Ảnh nền -->
              <img src="<?= $assets['hero_img_3'] ?? $assets['hero_img_3'] ?>" alt="Sale Banner"
              ...
              <div class="relative z-10 flex items-center justify-center h-full px-6">
                  <div class="text-center text-white max-w-2xl">
                      ...
                      <p class="text-base text-gray-200 mb-6">Nhanh tay đặt hàng để không bỏ lỡ cơ hội duy nhất trong
                          năm
                      </p>
                      <a href="index.php?controllers=product"
                          class="inline-block bg-black hover:bg-red-700 px-8 py-3 text-sm uppercase tracking-widest rounded-sm transition">
                          Mua Ngay
                      </a>
                  </div>
              </div>
